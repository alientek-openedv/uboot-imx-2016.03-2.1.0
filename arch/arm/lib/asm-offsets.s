	...
	.file	"asm-offsets.c"
@ GNU C11 (GCC) version 5.3.0 (arm-poky-linux-gnueabi)
...
@ -isysroot /opt/fsl-imx-x11/4.1.15-2.1.0/sysroots/cortexa7hf-neon-poky-linux-gnueabi
@ -D __KERNEL__ -D __UBOOT__ -D __ARM__ -D DO_DEPS_ONLY -D KBUILD_STR(s)=#s
@ -D KBUILD_BASENAME=KBUILD_STR(asm_offsets)
@ -D KBUILD_MODNAME=KBUILD_STR(asm_offsets)
@ -isystem /opt/fsl-imx-x11/4.1.15-2.1.0/sysroots/x86_64-pokysdk-linux/usr/lib/arm-poky-linux-gnueabi/gcc/arm-poky-linux-gnueabi/5.3.0/include
...
.LASF59:
	.ascii	"/home/alientek/alpha/alientek-alpha/uboot-alientek\000"
.LASF31:
